        ...
        <div class="top-triangle">
            <div class="top-triangle__carousel">
                <div class="item" style="background-image: url(/upload/iblock/651/651e01b5c95c4ef0043ae28417cdb6f6.jpg)">
                    ...
                    <div class="item__title item__title-small"><div>Проекты, которыми можно гордиться, получаются тогда, когда агентство действует как одна команда. Полное доверие в такой команде — это самый верный путь к созданию креативных, знаковых и эффективных кампаний. </div></div>
                </div>
            </div>
        </div>
    </div>
