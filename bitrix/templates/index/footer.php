...
<? $APPLICATION->IncludeComponent("bitrix:form.result.new", "template.pr.form", ["CACHE_TIME"             => "36000",
                                                                                 "CACHE_TYPE"             => "A",
                                                                                 "CHAIN_ITEM_LINK"        => "",
                                                                                 "CHAIN_ITEM_TEXT"        => "",
...
<? $APPLICATION->IncludeComponent("bitrix:form.result.new", "template.help.form", ["CACHE_TIME"             => "36000",
                                                                                   "CACHE_TYPE"             => "A",
                                                                                   "CHAIN_ITEM_LINK"        => "",
                                                                                   "CHAIN_ITEM_TEXT"        => "",
