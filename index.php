        ...
        <div class="content content__padding">
            <div class="quote">
                <div class="quote__text">
                    Основная цель PR сегодня состоит не в распространении информации и даже не в том, чтобы сделать
                    бренд заметным в перенасыщенном инфополе, а в том, чтобы установить дружеский личный контакт между
                    брендом и человеком.
                </div>
                <div class="quote__who">Михаил Умаров, CEO Comunica</div>
            </div>
            <div class="center">
                <a href="/about/#competencies"
                   class="btn btn__fixed"><span>Наши компетенции</span><span class="btn__icon btn__icon-arrow"></span></a>
            </div>
        </div>
    </div>
        ...
        <div class="content content__padding">
            ...
            <div class="cases">
                ...
                $res = CIBlockElement::GetList(["SORT" => "DESC",
                                                "ID"   => "DESC"], $arFilter, false, false, ['ID',
                                                                                             'IBLOCK_ID',
                                                                                             'NAME',
                                                                                             'PROPERTY_COMPANY',
                                                                                             'PREVIEW_PICTURE',
                ...
                <?if ($item['PROPERTY_CASE_LINK_VALUE'] != '') {
                    ...
                    <<?=$tag?> <?=$additionalAttr?> class="case <?=$additionalClass?>">
                        <div class="case__tbl">
                            <div>
            ...
            <div class="center">
                <a href="/cases/"
                   class="btn btn__fixed"><span>Все кейсы</span><span class="btn__icon btn__icon-arrow"></span></a>
            </div>
            ...
            <div class="center" style="margin-top: 40px">
                <a href="/products/"
                   class="btn btn__fixed"><span>Все продукты</span><span class="btn__icon btn__icon-arrow"></span></a>
            </div>
            ...
            <div class="feedback__btns">
                <a href="#form-need-pr"
                   data-fancybox
                   class="btn btn__big"><span><span>нужен международный PR?</span></span></a>
                <a href="#form-need-help" data-fancybox class="btn btn__big"><span><span>Нужна помощь<br>в кризисной ситуации?</span></span></a>
                <a href="https://t.me/comunicaprbot"
                   class="btn btn__big"
                   target="_blank"><span><span>PR BOT COMUNICA</span></span></a>
            </div>
        </div>
    </div>
